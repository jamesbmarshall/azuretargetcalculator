...
<?php include 'nav.php';?>
    ...
    <div class="column">
        ...
        <h2>Recurring Revenue</h2>
            ...
            me once for $5,000. You might not sell me anything else for weeks, months, or even years. If, however, you're selling me something like a cloud service at $1,000 per month, you get to bill me every month that I use the service - this means
            ...
            in the second month, it's worth $11,000 (11 months * $1,000 per month). This continues to diminish until you reach the last month, where if you add your customer then it's worth only $1,000 (1 month * $1,000 per month). So, if you adopt the same 
            approach of building pipeline and then looking to close deals at the end of the year, you'd need to add 100 customers in the last month of your year!</p>

            <p>Instead, if you add one customer per month (1.3 to be exact in this example!), you'd only need to add 15.4 to generate $100,000 of revenue in the same 12 month period.</p>
